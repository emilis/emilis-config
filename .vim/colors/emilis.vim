...
call s:higroupsfg( s:gray, [
    \ "Comment",
    \ "Noise",
    \ ])

call s:higroupsfg( s:green_hi, [
    \ "jsFunction",
    \ "jsFunctionKey",
    \ "jsArrowFunction",
    \ "jsReturn",
...
call s:higroupsfg( s:magenta_hi, [
    \ "Boolean",
    \ "Character",
    \ "Constant",
    \ "Float",
